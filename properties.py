...
possible_query = [
    "Udaipur", "Jaipur", "Jaisalmer", "Jodhpur", "Agra", "Delhi","Rishikesh", "Varanasi", "Goa", "Koksar",
    "Daman","Panarpani","Pushkar","Khajuraho","Manali","Bhimtal","Srinagar","Ranthambore","Coimbatore",
    "Shoja"
]